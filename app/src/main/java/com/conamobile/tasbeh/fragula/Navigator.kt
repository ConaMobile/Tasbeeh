package com.conamobile.tasbeh.fragula
...
import com.conamobile.tasbeh.fragula.adapter.NavigatorAdapter
import com.conamobile.tasbeh.fragula.common.Arg
import com.conamobile.tasbeh.fragula.common.BundleBuilder
import com.conamobile.tasbeh.fragula.common.FragmentNavigator
import com.conamobile.tasbeh.fragula.common.SwipeDirection
...
class Navigator : FragmentNavigator {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = ["com.conamobile.tasbeh.fragula.Navigator"]
        )
    )
    fun addFragment(
        fragment: Fragment,
